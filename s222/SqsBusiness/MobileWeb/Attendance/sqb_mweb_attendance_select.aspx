<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sqb_mweb_attendance_select.aspx.cs" Inherits="SqsBusiness.MobileWeb.Attendance.sqb_mweb_attendance_select" %>
    ...
    <form id="form1" runat="server">
      <div data-role="page" id="page_client_list" data-title="考勤查询" data-theme="c">
        <div data-role="header" data-position="inline" data-position="fixed" data-theme="c">
            <h1>
                考勤查询</h1>
            <a data-icon="back" class="ui-btn-left" onclick="javascript:location.href='sqb_mweb_attendance.aspx'">返回</a>
        </div>
