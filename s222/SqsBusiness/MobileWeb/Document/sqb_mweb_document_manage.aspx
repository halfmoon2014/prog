<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sqb_mweb_document_manage.aspx.cs" Inherits="SqsBusiness.MobileWeb.Document.sqb_mweb_document_manage" %>
...
<body>    
    ...
    <form id="form1" runat="server">
     <div data-role="page" id="page_client_list" data-title="文档管理" data-theme="c">
        ...
        <div data-role="content">
            <div data-role="collapsible-set">
                <a data-role="button" onclick="javascript:location.href='sqb_mweb_folder_list.aspx?type=public'">公共文档</a>
                <a data-role="button" onclick="javascript:location.href='sqb_mweb_folder_list.aspx?type=person'">个人文档</a>
            </div>
        </div>
