<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sqb_bweb_users.aspx.cs"
    Inherits="SqsBusiness.BackWeb.User.sqb_bweb_users" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/backweb/js/backweb/user/sqb_bweb_users.js"></script>
    <%--样式引用--%>
...
<body id="main" class="easyui-layout" style="border: 5px solid rgb(255,255,255);
    ...
    <form id="form_users" runat="server">
    <div data-options="region:'west',title:'组织架构',iconCls:'icon-layout',split:true,border:true"
        style="width: 180px; overflow: hidden;">
        <ul id="groups_tree" class="easyui-tree">
        </ul>
    </div>
    <div id="center" data-options="region:'center',title:'用户管理',border:true" style="overflow: hidden">
