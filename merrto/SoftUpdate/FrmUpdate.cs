       ...
       private void FrmUpdate_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (open == 0)
                {
                    if (this.isRun) Process.Start(mainAppExe);//打开新的应用程序
                }
                Application.Exit();
            }
        }
        ...
        private void DownUpdateFile()
        {
            ...
            {
                string UpdateFile = lvUpdateList.Items[i].Text.Trim()+".zip";
                string updateFileUrl = updateUrl + "/" + lvUpdateList.Items[i].Text.Trim() + ".zip";
                long fileLength = 0;
                ...
                try
                {
                    ...
                    int maximum = ZipClass.GetMaximums(lvUpdateList.Items[i].Text.Trim() + ".zip");
                    ZipClass.UnZip(Application.StartupPath + @"\" + lvUpdateList.Items[i].Text.Trim() + ".zip", "", maximum, FrmUpdate_SetProgress);
                    File.Delete(Application.StartupPath + @"\" + lvUpdateList.Items[i].Text.Trim() + ".zip");
        ...
        private void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (this.isRun) Process.Start(mainAppExe);
        }
